    ...
    class B_TAF_TeamLeader : TAF_SquadLeader_OCimport_02 {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_rifleman_FAL : B_TAF_TeamLeader {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_machinegunner : B_TAF_rifleman_FAL {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
        ...
        weapons[] = {"CUP_lmg_M240_norail","CUP_hgun_TT",""};
        respawnWeapons[] = {"CUP_lmg_M240_norail","CUP_hgun_TT",""};
        ...
        ALiVE_orbatCreator_loadout[] = {{"CUP_lmg_M240_norail","","","",{"CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",100},{},""},{},{"CUP_hgun_TT","","","",{"CUP_8Rnd_762x25_TT",8},{},""},{"usm_bdu_portliz",{{"FirstAidKit",2},{"SmokeShell",1,1},{"Chemlight_yellow",2,1},{"CUP_HandGrenade_M67",1,1}}},{"CUP_V_B_RRV_MG_GRN",{{"CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",2,100},{"CUP_8Rnd_762x25_TT",2,8}}},{"CUP_B_AlicePack_OD",{{"CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",4,100}}},"CUP_H_RUS_SSH68_olive","",{"","","","",{},{},""},{"ItemMap","","ItemRadio","ItemCompass","ItemWatch",""}};
    ...
    class B_TAF_Autorifleman : B_TAF_machinegunner {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_machinegunner_OCimport_01 : B_TAF_machinegunner { scope = 0; class EventHandlers; };
    class B_TAF_machinegunner_OCimport_02 : B_TAF_machinegunner_OCimport_01 { class EventHandlers; };

    class B_TAF_rifleman_FAL_OCimport_01 : B_TAF_rifleman_FAL { scope = 0; class EventHandlers; };
    class B_TAF_rifleman_FAL_OCimport_02 : B_TAF_rifleman_FAL_OCimport_01 { class EventHandlers; };


    class B_TAF_medic : B_TAF_machinegunner{
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
        displayName = "Medic";
    ...
    class B_TAF_engineer : B_TAF_medic {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_marksman : B_TAF_rifleman_FAL_OCimport_02 {
	author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_rifleman : B_TAF_TeamLeader {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_autorifleman_ass : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_machinegunner_ass : B_TAF_autorifleman_ass {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_RTO : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_vehcrew : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_pilot : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
        displayName = "Pilot";
    ...
    class B_TAF_rifleman_at : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_rifleman_at_ass : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_survivor : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_TAF_officer : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
        displayName = "Officer";
    ...
    class B_TAF_policeman : B_TAF_rifleman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
        ...
        weapons[] = {"CUP_arifle_AKMS_Early","CUP_hgun_Makarov"};
        respawnWeapons[] = {"CUP_arifle_AKMS_Early","CUP_hgun_Makarov"};
        ...
        ALiVE_orbatCreator_loadout[] = {{"CUP_arifle_AKMS_Early","","","",{"CUP_30Rnd_762x39_AK47_bakelite_M",30},{},""},{},{"CUP_hgun_Makarov","","","",{"CUP_8Rnd_9x18_Makarov_M",8},{},""},{"usm_bdu_odg",{{"FirstAidKit",1},{"SmokeShell",1,1},{"Chemlight_yellow",2,1},{"CUP_8Rnd_9x18_Makarov_M",2,8}}},{"V_TacVest_blk",{{"CUP_30Rnd_762x39_AK47_bakelite_M",3,30}}},{},"usm_bdu_cap_odg","",{},{"ItemMap","","ItemRadio","ItemCompass","ItemWatch",""}};
    ...
    class B_TAF_policeman_light : B_TAF_policeman {
        author = "Martin";
        scope = 2;
        scopeCurator = 2;
